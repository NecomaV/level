...
#     Франшиза Темиртау
#     Франшиза Аурум Астана
#     Франшиза Proff Dental   (ташкентская логика: платники И продажи в сомах -> /$H$1)
#
# ЗАКРЫТЫЕ (убраны из маппинга — в overall не обсчитываются, строки не трогаем):
#     Филиал Опатра Айви Алматы  -> лист "Сводка Опатра Айви Алматы"
#     Филиал Фэшн Астана         -> лист "Сводка Фэшн Астана"
#   Если метка ещё осталась в overall!B, скрипт просто напишет
#   "[WARN] label not mapped (skip)" и оставит строку как есть.
LABEL_TO_SVODKA_RAW: Dict[str, str] = {
    ...
    "Vitally Life Уалихана": "Сводка Vitally Уалихана",
    # ---- Франшизы ----
